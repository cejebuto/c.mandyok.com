...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div class="form_publish">
            <?php osc_current_web_theme_path('inc.search.php') ;  echo 'Tambien puedes seleccionar una categoria'; ?>
...
Este espacio esta Justo antes del Los Nuevos Anincios
...
-->';
               ...
               <div class="latest_ads">
                    <h1><strong><?php _e('Últimas Publicaciones', 'modern') ; ?></strong></h1>
                    <?php if( osc_count_latest_items() == 0) { ?>
                        <p class="empty"><?php _e('No hay publicaciones recientes que mostrar', 'modern') ; ?></p>
                    <?php } else { ?>
